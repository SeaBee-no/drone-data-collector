...
class DLB:
    ...
    def __init__(self, **kwargs):
        ...
        self.dlb_api_key = "ak_41ec9da1-c028-4662-8af5-70688f49887a"
        self.dlb_url = "https://andoyaspace.dronelogbook.com"
        self.flights = None
...
class Flight:
    ...
    def __init__(self, data):
        ...
        try:
            self.flight_time = data['flight_date_utc'] #datetime.strptime(data['flight_date_utc'], '%Y-%m-%dT%H:%M:%S.%fZ')
        except ValueError:
